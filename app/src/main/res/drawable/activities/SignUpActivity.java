...
import com.rohya.vaartaalaap.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp()
    {
        ...
        user.put(Constants.KEY_KEY_IMAGE, encodedImage);
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    prefrenceManager.putString(Constants.KEY_KEY_IMAGE, encodedImage);
